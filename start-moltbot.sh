...
echo "PRODUCTHUNT_API_KEY: ${PRODUCTHUNT_API_KEY:+[SET]}"
echo "PRODUCTHUNT_API_SECRET: ${PRODUCTHUNT_API_SECRET:+[SET]}"
echo "PRODUCTHUNT_DEVELOPER_TOKEN: ${PRODUCTHUNT_DEVELOPER_TOKEN:+[SET]}"
...
export PRODUCTHUNT_API_KEY="${PRODUCTHUNT_API_KEY}"
export PRODUCTHUNT_API_SECRET="${PRODUCTHUNT_API_SECRET}"
export PRODUCTHUNT_DEVELOPER_TOKEN="${PRODUCTHUNT_DEVELOPER_TOKEN}"
