...
export function getEnvFingerprint(env: MoltbotEnv): string {
  ...
  if (env.PRODUCTHUNT_API_KEY) keys.push('PRODUCTHUNT_API_KEY');
  if (env.PRODUCTHUNT_API_SECRET) keys.push('PRODUCTHUNT_API_SECRET');
  if (env.PRODUCTHUNT_DEVELOPER_TOKEN) keys.push('PRODUCTHUNT_DEVELOPER_TOKEN');
...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  if (env.PRODUCTHUNT_API_KEY) envVars.PRODUCTHUNT_API_KEY = env.PRODUCTHUNT_API_KEY;
  if (env.PRODUCTHUNT_API_SECRET) envVars.PRODUCTHUNT_API_SECRET = env.PRODUCTHUNT_API_SECRET;
  if (env.PRODUCTHUNT_DEVELOPER_TOKEN) envVars.PRODUCTHUNT_DEVELOPER_TOKEN = env.PRODUCTHUNT_DEVELOPER_TOKEN;
